...
public class ISBN2{
	public   void Data1(String str) throws IOException {
		...
		URL source = new URL("https://www.abebooks.com/servlet/SearchResults?fe=on&n=100121501+200000102&pt=book&bi=s&sortby=17&isbn="+str);
		...
		while ((inputLine = in.readLine()) != null) {
			...
			indexForTitle=inputLine.indexOf("Computer");

			if(inputLine.indexOf("Computer")!=-1) {
				...
				System.out.print("\nAuthor's name:\n");
				indexForTitle=inputLine.indexOf("Das");
		...
		URL source1 = new URL("https://wordery.com/computer-science-a-very-short-introduction-subrata-dasgupta-"+str);
		...
		URL source2 = new URL("https://www.chapters.indigo.ca/en-ca/books/computer-science-a-very-short/"+str+"-item.html?ref=isbn-search");
