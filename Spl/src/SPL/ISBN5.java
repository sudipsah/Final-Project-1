...
public class ISBN5{
	public   void Data1(String str) throws IOException {
		...
		URL source = new URL("https://www.abebooks.com/servlet/BookDetailsPL?bi=22743611496&searchurl=kn%3D"+str+"%26sortby%3D17%26n%3D100046078&cm_sp=snippet-_-srp1-_-title2");
		...
		while ((inputLine = in.readLine()) != null) {
			...
			indexForTitle=inputLine.indexOf("Comp");
			...
			if(indexForTitle!=-1) {
				...
				System.out.print("\nAuthor's name:\n");
				indexForTitle=inputLine.indexOf("Sedg");
